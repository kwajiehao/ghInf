# plot the performance of the cholesky function in the Matrix package relative to optimal fill-in
...
print(results) # not optimal! with reverse labelling the ratio is very bad.
